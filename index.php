    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="hero-content" id="contact-section">
          ...
          <form action="sendmsg.php" method="post" class="row g-3 needs-validation" novalidate>
                <div class="col-md-12">
    ...
    <section class="portfolio py-5" id="portfolio">
        <div class="portfolio-content1">
                    <div class="row">
                        ...
                        <div class="see lets">
                            <a href="#">See More <i class="fa-solid fa-caret-down"></i></a>
                        </div>
                    </div>
        ...
        <div class="hero-content">
                    ...
                    <h1 class="display-5 fw-bold mb-4">Let's make something awesome together!</h1>
                     <form class="row g-3 needs-validation" novalidate>
                            ...
                            <div class="col-md-6">
                                <input id="phone2" type="tel" class="form-control bg-dark text-white border-secondary" 
                                    placeholder="Phone Number*" required>
                            </div>
